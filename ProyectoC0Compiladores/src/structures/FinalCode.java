    ...
    private void processLine(IntermediateLine line){
        ...
        switch(line.command){
            case "END":
                ...
                break;
            case "PUT_CONSTANT":
                String temp = line.op1+": DATA"+space;
                this.file.write(temp.substring(0,space.length())+line.res);
                break;
            case "PRINT_CONSTANT":
            ...
            case "PRINT_INT":
                ...
                break;
            case "LABEL":
                String temp2 = line.res+":"+space;
                this.file.write(temp2.substring(0,space.length())+"NOP");
                break;
            case "JUMP_LABEL":
